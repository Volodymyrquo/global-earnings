...
import arrowRed from '../../assets/images/leaderboard/arrowRed.svg'
import BarChart from './globalEarnings'

const TotalsBySections = () => {
...
export default React.memo(TotalsBySections)
